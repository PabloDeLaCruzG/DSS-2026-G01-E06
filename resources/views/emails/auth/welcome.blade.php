...
<head>
    ...
    <title>Bienvenido a GameLink</title>
</head>
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:620px;background-color:#ffffff;border-radius:14px;overflow:hidden;border:1px solid #e5e7eb;">
                <tr>
                    <td style="background-color:#eaf8f8;padding:24px 28px 18px 28px;text-align:center;">
                        ...
                        <p style="margin:0;color:#007a7c;font-size:13px;font-weight:700;letter-spacing:0.03em;text-transform:uppercase;">No Reply · Cuenta creada</p>
                    </td>
                </tr>
                <tr>
                    <td style="padding:28px;">
                        <h1 style="margin:0 0 14px 0;font-size:22px;line-height:1.3;color:#0d1520;">Bienvenido a GameLink</h1>

                        <p style="margin:0 0 14px 0;font-size:15px;line-height:1.7;color:#334155;">
                            Hola {{ $user->name ?? 'usuario' }}, tu cuenta se ha creado correctamente y ya puedes empezar a comprar y vender en GameLink.
                        </p>

                        <p style="margin:0 0 22px 0;font-size:15px;line-height:1.7;color:#334155;">
                            Explora el marketplace y encuentra las mejores ofertas en videojuegos digitales y físicos.
                        </p>

                        <table role="presentation" cellspacing="0" cellpadding="0" style="margin:0 0 22px 0;">
                            <tr>
                                <td>
                                    <a href="{{ $homeUrl }}" style="display:inline-block;background:#009194;color:#ffffff;text-decoration:none;font-weight:700;font-size:14px;line-height:1;padding:12px 18px;border-radius:10px;">
                                        Ir al marketplace
                                    </a>
                                </td>
                            </tr>
