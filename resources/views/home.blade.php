...
@section('content')
    ...
    <section class="mb-8">
        ...
        <div class="flex gap-2 flex-wrap">
            <button class="text-xs px-3 py-1.5 rounded-full bg-violet-600 border border-violet-600 text-white">All Platforms</button>
            <button class="text-xs px-3 py-1.5 rounded-full border border-gray-600 text-gray-400 hover:border-gray-400 hover:text-white transition-colors">PlayStation 5</button>
            <button class="text-xs px-3 py-1.5 rounded-full border border-gray-600 text-gray-400 hover:border-gray-400 hover:text-white transition-colors">Xbox Series X</button>
            <button class="text-xs px-3 py-1.5 rounded-full border border-gray-600 text-gray-400 hover:border-gray-400 hover:text-white transition-colors">Nintendo Switch</button>
            <button class="text-xs px-3 py-1.5 rounded-full border border-gray-600 text-gray-400 hover:border-gray-400 hover:text-white transition-colors">PC Gaming</button>
            <button class="text-xs px-3 py-1.5 rounded-full border border-gray-600 text-gray-400 hover:border-gray-400 hover:text-white transition-colors">Retro</button>
        </div>
    </section>
